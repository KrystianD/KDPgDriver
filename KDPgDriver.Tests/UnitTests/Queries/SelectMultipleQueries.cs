...
SELECT 
  t0 IS NULL,<COLUMNS:MyModel:t0>,t1 IS NULL,t1.""id"",t1.name1,t1.model_id
FROM
...
WHERE 
  (NOT((t1) IS NULL)) AND ((t0.""name"") = ('Q'))");
    ...
    public void SelectMultipleNew()
    {
      ...
      Utils.AssertRawQueryWithAliases(q, @"
SELECT 
 t0 IS NULL,<COLUMNS:MyModel:t0>,t1.name1,(t1.""id"") * (2)
FROM
  model t0 LEFT JOIN ""public"".model2 t1 ON ((t0.""id"") = (t1.model_id))");
    }
...
");
    ...
    public void SelectMultipleSelfJoin()
    {
      ...
      Utils.AssertRawQueryWithAliases(q, @"
SELECT 
  t1 IS NULL,<COLUMNS:MyModel:t1>,t0 IS NULL,<COLUMNS:MyModel:t0>
FROM
...
LEFT JOIN ""public"".model2 t3 ON ((t0.""id"") = (t3.""id""))");
    ...
    public void SelectMultipleCustomDto()
    {
      ...
      Utils.AssertRawQuery(q, @"SELECT (t1.""id"") * (2),t0 IS NULL,<COLUMNS:MyModel:t0>
FROM
  model t0 LEFT JOIN model t1 ON ((t0.""id"") = (t1.""id""))");
    }
  }
