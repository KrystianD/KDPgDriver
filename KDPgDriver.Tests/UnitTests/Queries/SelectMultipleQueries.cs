...
SELECT 
  t0 IS NULL,t0.""id"",t0.""name"",t0.list_string,t0.list_string2,(t0.""enum"")::text,(t0.list_enum)::text[],(t0.enum2)::text,t0.enum_text,t0.""date"",t0.""time"",t0.datetime,t0.json_object1,t0.json_model,t0.json_array1,t0.bool,t0.""binary"",t0.private_int,t0.val_f32,t0.val_f64,t0.int_nullable,t1 IS NULL,t1.""id"",t1.name1,t1.model_id
FROM
...
WHERE 
  (NOT((t1) IS NULL)) AND ((t0.""name"") = ('Q'))");
    ...
    public void SelectMultipleNew()
    {
      ...
      Utils.AssertRawQueryWithAliases(q, @"
SELECT 
 t0 IS NULL,t0.""id"",t0.""name"",t0.list_string,t0.list_string2,(t0.""enum"")::text,(t0.list_enum)::text[],(t0.enum2)::text,t0.enum_text,t0.""date"",t0.""time"",t0.datetime,t0.json_object1,t0.json_model,t0.json_array1,t0.bool,t0.""binary"",t0.private_int,t0.val_f32,t0.val_f64,t0.int_nullable,t1.name1,(t1.""id"") * (2)
FROM
  model t0 LEFT JOIN ""public"".model2 t1 ON ((t0.""id"") = (t1.model_id))");
    }
...
");
    ...
    public void SelectMultipleSelfJoin()
    {
      ...
      Utils.AssertRawQueryWithAliases(q, @"
SELECT 
  t1 IS NULL,t1.""id"",t1.""name"",t1.list_string,t1.list_string2,(t1.""enum"")::text,(t1.list_enum)::text[],(t1.enum2)::text,t1.enum_text,t1.""date"",t1.""time"",t1.datetime,t1.json_object1,t1.json_model,t1.json_array1,t1.bool,t1.""binary"",t1.private_int,t1.val_f32,t1.val_f64,t1.int_nullable,t0 IS NULL,t0.""id"",t0.""name"",t0.list_string,t0.list_string2,(t0.""enum"")::text,(t0.list_enum)::text[],(t0.enum2)::text,t0.enum_text,t0.""date"",t0.""time"",t0.datetime,t0.json_object1,t0.json_model,t0.json_array1,t0.bool,t0.""binary"",t0.private_int,t0.val_f32,t0.val_f64,t0.int_nullable
FROM
...
WHERE 
  (NOT((t1) IS NULL)) AND (NOT((t0) IS NULL))");
    ...
    public void SelectMultipleReturnSingleTable()
    {
      ...
      Utils.AssertRawQueryWithAliases(q, @"
SELECT 
  t0 IS NULL,t0.""id"",t0.""name"",t0.list_string,t0.list_string2,(t0.""enum"")::text,(t0.list_enum)::text[],(t0.enum2)::text,t0.enum_text,t0.""date"",t0.""time"",t0.datetime,t0.json_object1,t0.json_model,t0.json_array1,t0.bool,t0.""binary"",t0.private_int,t0.val_f32,t0.val_f64,t0.int_nullable
FROM
  model t0 LEFT JOIN model t1 ON ((t0.""id"") = (t1.""id""))");
    }
